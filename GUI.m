...
bg = imread('poza.catelGAC.png'); imagesc(bg);
...
switch get(handles.axes1,'visible')
    ...
    case 'off'
       set(handles.axes1,'visible','on') %make visible the current axes
       set(get(handles.axes1,'children'),'visible','on') %make visible the current axes contents
end
...
S.fh = figure('units','pixels',...
              ...
              'menubar','none',...
              'name','Fun Fact - Me in this session',...
              'numbertitle','off',...
              'resize','off');
w = imread('pisicainsesiune.png');
